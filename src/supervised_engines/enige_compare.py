...
def play_game_engines(chess_board_instance):
    ...
    while not is_over:
        ...
        chess_lib.trying_nnues(chess_board_instance ,ctypes.c_int(3), ctypes.c_int(3), ctypes.c_int(-999999), ctypes.c_int(999999), ctypes.byref(score1), ctypes.byref(count1))
