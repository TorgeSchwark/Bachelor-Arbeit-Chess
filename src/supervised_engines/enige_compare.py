...
def compare_engines_thread(chess_board_instance, games_amount=5000):
    ...
    num_threads = 32  # Anzahl der Threads
    pool = Pool(32)
...
def play_game_engines(chess_board_instance):
    ...
    while not is_over:
        ...
        chess_lib.alpha_beta_basic(chess_board_instance,ctypes.c_int(3), ctypes.c_int(3), ctypes.c_int(-999999), ctypes.c_int(999999), ctypes.byref(score2), ctypes.byref(count2))
        ...
        chess_lib.alpha_beta_basic(chess_board_instance ,ctypes.c_int(3), ctypes.c_int(3), ctypes.c_int(-999999), ctypes.c_int(999999), ctypes.byref(score1), ctypes.byref(count1))
